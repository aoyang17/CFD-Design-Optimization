...
def get_rans_crm_wing():
    ...
    data = pd.read_csv("./Aero_all_conditions_wing/Aero_ADODG_1pt.csv")
    # data = pd.read_csv("./Aero_all_conditions_wing/Aero_ADODG_9pt.csv")
    # data = pd.read_csv("./Aero_all_conditions_wing/Aero_GMM_cruise_9pts.csv")
    # data = pd.read_csv("./Aero_all_conditions_wing/Aero_GMM_entire_9pts.csv")
    # data = pd.read_csv("./Aero_all_conditions_wing/Aero_GMM_entire_17pts.csv")
    # data = pd.read_csv("./Aero_all_conditions_wing/Aero_GMM_entire_22pts.csv")
