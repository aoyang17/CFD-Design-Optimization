...
parser.add_argument("--output", type=str, default="output_ADODG_L3_5pts")
parser.add_argument("--opt", type=str, default="SLSQP", choices=["IPOPT", "SLSQP", "SNOPT"])
parser.add_argument("--gridFile", type=str, default="ADODG4_Multiblock_Structured_Mesh_L3.cgns")
...
ap = AeroProblem(name="wing", alpha=alpha, mach=mach, altitude=alt, reynolds=5e6, \
    reynoldsLength=1.0, T=326.45, areaRef= 3.407014, chordRef=1.0, \
    xRef=1.20777, yRef=0, zRef=.007669, evalFuncs=["cl", "cd"])

ap.addDV("alpha", value=alpha, lower=1.0, upper=5.0,scale=1)
