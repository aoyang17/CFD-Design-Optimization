...
def saveData(flightNum):
    ...
    df = df.transpose()
    df.to_csv("./mission_analysis_database/gmm_entire_20/p3_short_%d.csv"%flightNum, encoding='utf-8')
...
if __name__ == '__main__':
    ...
    for index, row in sample_airlines.iterrows():
        ...
        new_data.to_csv("airlines_MA_fuel_all_optimized_gmm_entire_20.csv", mode='a', header=False, index=False)
